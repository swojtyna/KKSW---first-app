...
<required_reading>
@/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done/references/ai-frameworks.md
@/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/agents/gsd-eval-planner.md for instructions.

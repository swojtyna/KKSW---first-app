...
```bash
PHASE_INFO=$(node "/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```

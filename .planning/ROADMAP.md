...
- [ ] 05-05-dam-extension-handlers-PLAN.md (wave 2) — DAM extension intervalDidStart + intervalDidEnd schedule paths with prefix dispatch + weekday filter + multi-marker writes + Darwin posts (SCH-03 core; SCH-04 delivered by Phase 4 shield parity — zero new shield code)

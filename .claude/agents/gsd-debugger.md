...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude
                  → checks /Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done
                  → writes to /Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done/hooks/
...
@/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```

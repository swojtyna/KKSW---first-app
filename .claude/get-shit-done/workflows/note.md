...
- **Global scope**: `/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/notes/`)
...
2. Glob `/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/notes/` — works in any directory

...
```bash
cp "/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/get-shit-done/USER-PROFILE.md" "/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/Users/swojtyna/Documents/code/swojtyna/KKSW---first-app/.claude/USER-PROFILE.backup.md"
```
